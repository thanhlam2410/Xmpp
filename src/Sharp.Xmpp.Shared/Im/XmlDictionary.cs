...
namespace Sharp.Xmpp.Im
{
    ...
    internal class XmlDictionary : IDictionary<string, string>
    {
        ...
        public XmlDictionary(XElement element, string tag, string key)
        {
        ...
        public ICollection<string> Keys
        {
            get
            {
                ...
                foreach (XElement e in element.GetElementsByTagName(tag))
                {
                    string k = e.GetAttributeValue(this.key);
        ...
        {
            XElement e = GetElement(item.Key);
            if (e != null)
